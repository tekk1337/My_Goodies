...
$vulnUS = New-Object System.Net.Sockets.TcpClient("endpoint.ingress.rapid7.com", 443) | select -ExpandProperty Connected
$vulnCA = New-Object System.Net.Sockets.TcpClient("ca.endpoint.ingress.rapid7.com", 443) | select -ExpandProperty Connected
$vulnEU = New-Object System.Net.Sockets.TcpClient("eu.endpoint.ingress.rapid7.com", 443) | select -ExpandProperty Connected
$vulnAU = New-Object System.Net.Sockets.TcpClient("au.endpoint.ingress.rapid7.com", 443) | select -ExpandProperty Connected
$vulnAP = New-Object System.Net.Sockets.TcpClient("ap.endpoint.ingress.rapid7.com", 443) | select -ExpandProperty Connected
...
Write-Output "Vulnerability Scanning Port (U.S.) Connected:           $vulnUS"
Write-Output "Vulnerability Scanning Port (Canada) Connected:         $vulnCA"
Write-Output "Vulnerability Scanning Port (EU) Connected:             $vulnEU"
Write-Output "Vulnerability Scanning Port (Australia) Connected:      $vulnAU"
Write-Output "Vulnerability Scanning Port (Asia Pacific) Connected:   $vulnAP"
